	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/farm2-1.png');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="registrPro.jsp">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="비밀번호를 입력하세요.">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="주소를 입력하세요.">
						<input class="input100" type="text" name="addr" placeholder="주소">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
					
			
					<div class="wrap-input100 validate-input m-b-23" data-validate="휴대폰번호를 입력하세요.">
